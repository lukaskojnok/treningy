...
<head>
  ...
  <script src="/js/calendar.js?<?= time(); ?>" defer></script>
</head>
<body class="planner-body">
  <main class="planner">
    <header class="topbar">
      ...
      <div class="menu-wrap">
        ...
        <nav id="main-menu" hidden aria-label="Hlavná navigácia"><strong>Tréningy · MFK Revúca</strong><button type="button" id="menu-quick">Rýchla editácia tréningov</button><button type="button" id="menu-calendar">Sumárny kalendár</button><button type="button" id="menu-day">Ihriská - kalendár</button><button type="button" id="menu-fields">Ihriská - plochy</button><a href="/?logout=1">Odhlásiť sa ↗</a></nav>
      </div>
    </header>
    ...
    <section class="toolbar" aria-label="Ovládanie kalendára">
      <div class="switch"><button class="button selected" id="view-quick" aria-pressed="true">Rýchla editácia tréningov</button><button class="button" id="view-calendar" aria-pressed="false">Sumárny kalendár</button><button class="button" id="view-day" aria-pressed="false">Ihriská - kalendár</button><button class="button" id="view-fields" aria-pressed="false">Ihriská - plochy</button></div>
  ...
  <dialog id="quick-team-dialog" aria-labelledby="quick-team-title">
    <div class="dialog-heading"><div><p class="eyebrow">RÝCHLA EDITÁCIA</p><h2 id="quick-team-title">Vyber tím</h2></div><button class="button" type="button" id="quick-team-close" aria-label="Zavrieť">✕</button></div>
    <p class="dialog-note">Pre ktorý tím pridávaš tréning?</p>
    <div id="quick-team-options" class="quick-team-options"></div>
  </dialog>
</body>
</html>
