...
<head>
  ...
  <link rel="stylesheet" href="css/css.css?v=20260908-clean">
  ...
  <script src="js/calendar.js?v=20260908-clean" defer></script>
</head>
<body class="planner-body">
  <main class="planner">
    <header class="topbar">
      <div class="heading"><span class="eyebrow">MFK REVÚCA / PLÁNOVANIE</span><h1>Rezervácie ihrísk</h1></div>
      <span class="demo-label">Vizuálna ukážka · dáta len do obnovenia stránky</span>
    ...
    <div class="legend"><div id="field-legend"></div><span class="legend-tip" id="calendar-tip">Ukážka: minulý, aktuálny a budúci týždeň · rôzne časy</span><button class="button" id="morning">Od 08:00</button><button class="button" id="afternoon">Od 14:00</button></div>
    ...
    <footer class="planner-footer"><span>Ukážkové ihriská a tréningy · rezervácie sa nezdieľajú medzi trénermi</span><span>08:00 – 22:00 · rezervácie ihrísk</span></footer>
  </main>
  <dialog id="event-dialog" aria-labelledby="dialog-title">
    <form id="event-form">
      ...
      <p class="dialog-note">Ukážka formulára. Zmeny zostanú len do obnovenia stránky.</p>
      <label>Názov tréningu / tím<input name="title" required maxlength="70" placeholder="Napr. U15 · tímový tréning"></label>
      <label>Tréner<input name="coach" required maxlength="60" placeholder="Meno trénera"></label>
      ...
      <div class="dialog-actions"><button class="button danger" type="button" id="delete-event" hidden>Vymazať</button><span></span><button class="button" type="button" id="cancel-dialog">Zrušiť</button><button class="button primary" type="submit">Uložiť rezerváciu</button></div>
    </form>
  </dialog>
